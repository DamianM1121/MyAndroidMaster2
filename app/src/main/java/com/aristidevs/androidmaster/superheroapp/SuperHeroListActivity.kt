...
import com.aristidevs.androidmaster.superheroapp.Database.SuperHeroDB.RegisterView.RegisterHeroActivity
//import com.aristidevs.androidmaster.superheroapp.Database.SuperHeroDB.UseCase.HeroUseCase
...
import com.aristidevs.androidmaster.superheroapp.SuperheroItemResponse as SuperheroItemResponse
...
class SuperHeroListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Asignamos la lógica al botón btnRegister.
        binding.btnRegister.setOnClickListener {
            openRegisterHeroActivity()
        }
    }
    ...
    private fun openRegisterHeroActivity() {
        val intent = Intent(this, RegisterHeroActivity::class.java)
        startActivity(intent)
    }
